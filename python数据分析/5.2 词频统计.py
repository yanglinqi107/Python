...
def count_of_words(txt):
    ...
    # =======================================================
    lst = txt.split()
    # dictmp = word_frequency(txt)
    allwords = len(lst)
    unrepeat = len(set(lst))
    return allwords, unrepeat
    # =======================================================
...
def top_ten_words_no_excludes(frequency, cnt):
    ...
    # =======================================================
    excludes_words = [
        'a', 'an', 'the', 'i', 'he', 'she', 'his', 'my', 'we', 'or', 'is',
        'was', 'do', 'and', 'at', 'to', 'of', 'it', 'on', 'that', 'her', 'c',
        'in', 'you', 'had', 's', 'with', 'for', 't', 'but', 'as', 'not',
        'they', 'be', 'were', 'so', 'our', 'all', 'would', 'if', 'him', 'from',
        'no', 'me', 'could', 'when', 'there', 'them', 'about', 'this', 'their',
        'up', 'been', 'by', 'out', 'did', 'have'
    ]
    for word in excludes_words:
        del frequency[word]
    top_ten_words(frequency, cnt)
    # =======================================================
